...
# anime_list = {
#     '兔女郎': {
#         'preference': ['c.c动漫', 'c-a Raws'],  #这个是字幕组的偏向,排到越前面的越优先,访问 miobt.com 就知道应该怎么选啦,如果留为[]就是选最近的
#         'date': 'thursday',
#         'time': '03:00',
...
# 例:download_path = 'D:\\Downloads' 或者 download_path = '/home/user/downloads'
ip_address = '127.0.0.1'  # transmission rpc的地址(默认值是本机)
port = 9091  # 这个一般留默认
